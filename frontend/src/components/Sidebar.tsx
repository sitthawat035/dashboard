...
import { Rocket, LayoutDashboard, Bot, Terminal, Cpu, Shield, LogOut, Zap, Menu, X, Gamepad2, Sparkles, BarChart3, Globe, Monitor } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: 'social' as TabId, label: 'Social Hub', icon: Globe },
    { id: 'mission' as TabId, label: 'Mission Control', icon: Gamepad2 },
    { id: 'agents' as TabId, label: 'Agents', icon: Bot },
    // 'terminal' (PowerShell) removed — replaced by QuickLinks widget
    { id: 'multi' as TabId, label: 'Engine Hub', icon: Cpu },
    { id: 'hermes' as TabId, label: 'Hermes Bridge', icon: Sparkles },
    { id: 'broadcast-monitor' as TabId, label: 'Broadcast Monitor', icon: Monitor },
    { id: 'cli-helper' as TabId, label: 'CLI Helper', icon: Terminal },
