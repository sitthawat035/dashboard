...
# 5. _metadata.json
        ...
        # 6. 02_content.json — required by image_gen engine (gen_from_prompt.py)
        content_json = {
            "content": {
                "text": body_text,
                "insight_score": insight_score,
