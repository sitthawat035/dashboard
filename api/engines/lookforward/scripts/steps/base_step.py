...
# New organized directory structure (configurable via env)
        lookforward_root = os.getenv("LOOKFORWARD_OUTPUT_ROOT")
        if lookforward_root:
            lf_root = Path(lookforward_root)
        else:
            lf_root = self.root_dir

        self.drafts_dir = lf_root / "data" / "content" / "lookforward" / "drafts"
        self.ready_dir = lf_root / "data" / "content" / "lookforward" / "ready_to_post"
        self.published_dir = lf_root / "data" / "content" / "lookforward" / "published"
        self.state_dir = lf_root / "data" / "content" / "lookforward" / "state"
