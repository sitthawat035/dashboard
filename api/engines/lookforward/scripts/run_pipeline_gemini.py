...
def create_ready_to_post(topic, content_data, images):
    ...
    # 6. 02_content.json — required by gen_from_prompt.py for image_prompts
    with open(post_dir / "02_content.json", "w", encoding="utf-8") as f:
        json.dump(content_data, f, indent=2, ensure_ascii=False)
    print_info(" ✅ 02_content.json (image_prompts for gen engine)")
