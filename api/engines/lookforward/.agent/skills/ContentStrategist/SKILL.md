...
description: Analyze tech trends and create high-authority content strategies for "lookforward"
---

# ContentStrategist Skill (lookforward Edition)

## 🎯 Purpose
วิเคราะห์แนวโน้มเทคโนโลยี (AI, Tech, Crypto) เพื่อวางกลยุทธ์เนื้อหาที่เน้นการสร้าง Authority และ Trust โดยเน้นการหา 'Insight' ที่คนส่วนใหญ่พยายามมองข้าม

## 📥 Input Files
1. **Trend Data**: `01_Research/trends/YYYY-MM-DD.md`
...
- **Topic**: หัวข้อที่เน้นความน่าเชื่อถือ
- **Core Angle**: มุมมองเชิงระบบ (Systemic Perspective)
- **Key Technical Points**: ประเด็นทางเทคนิคที่ต้องระบุให้ครบถ้วน
- **Future Vision**: บทวิเคราะห์อนาคตสั้นๆ
- **Drafting Instructions**: คำแนะนำสำหรับ ContentWriter (เน้น No-Hype)
