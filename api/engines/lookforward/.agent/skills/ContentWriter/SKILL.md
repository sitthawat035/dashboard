---
name: ContentWriter
description: Write high-authority tech analysis and future-focused insights for "lookforward"
---

# ContentWriter Skill (lookforward Edition)

## 🎯 Purpose
เปลี่ยนข้อมูลดิบหรือกลยุทธ์ให้กลายเป็นบทความวิเคราะห์เทคโนโลยีที่ลุ่มลึก น่าเชื่อถือ และสร้างความเชื่อมั่น (Authority) ให้กับเพจ lookforward

## 📥 Input Files
1. **Strategy**: `02_Strategy/content_plans/YYYY-MM-DD_[topic].md`
2. **Media**: `03_Media/YYYY-MM-DD_[topic]_summary.md`
