...
CONFIG_FILE = Path(os.getenv('AMERI_CONFIG_FILE', str(DASHBOARD_DIR / "data" / "config" / "ameri_settings.json")))

# Default fallback settings
DEFAULT_CONFIG = {
    "ameri_status": os.getenv('AMERI_STATUS', 'active'),
    "content_strategy": {
        "niche": os.getenv('AMERI_NICHE', 'Tech & Engineering'),
        "tone": os.getenv('AMERI_TONE', 'Formal')
    },
    "dashboard_bridge": {
