...
- **Constraint:** **ห้ามเขียนโค้ดเอง** ให้ส่งต่อแผนงานไปที่ Coder-Agent เท่านั้น (ถ้า user ขอให้แก้เองให้ข้ามไป stage 2 ทันที)    
...
- **Verdict:**
  - **FAIL:** สรุปรายการ Error และส่งกลับไป Stage 1 ทันที (ห้ามแก้ไขเอง)   
